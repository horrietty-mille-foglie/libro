...
function BookRowList({ book, onClick }) {
  return (
    <div
      onClick={onClick}
      className="flex items-center gap-4 bg-white px-4 py-3 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors"
    >
      <div className="w-10 h-14 flex-shrink-0 bg-gray-100 rounded overflow-hidden flex items-center justify-center">
        {book.cover_url ? (
      ...
      <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-sm px-3 py-1.5 border border-gray-300 rounded-md text-gray-600 hover:bg-gray-100 transition-colors cursor-pointer"
          >
            ログアウト
          </button>
        </div>
