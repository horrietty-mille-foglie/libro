        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-5">
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-700 mb-1">章</label>
              <input
                type="text"
                value={form.chapter}
            ...
            <div className="w-24">
              <label className="block text-sm font-medium text-gray-700 mb-1">ページ</label>
              <input
                type="number"
                value={form.page}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">引用</label>
            <textarea
              value={form.quote}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">考察</label>
            <textarea
              value={form.thought}
